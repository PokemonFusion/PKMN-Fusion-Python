...
A1.turninit = TurnInit("A1", attack=CombatCode.battledata.DeclareAttack('B1', pglobals.Moves("tackle")))
...
B1.turninit = TurnInit("B1", attack=CombatCode.battledata.DeclareAttack('A1', pglobals.Moves("tackle")))
